...
const PhoneCard = ({ phone }) => {
    ...
    const handleAddToFavorites = () => {
        ...
        if (!favoriteItems) {
            ...
            if (!isExist) {
                ...
                swal("Already exists!", "No duplecates!", "error");
    ...
    return (
        <div className="flex justify-center items-center h-[80vh]">
            <div key={id} className="relative flex w-full max-w-[48rem] flex-row rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
